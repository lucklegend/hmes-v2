...
class requestPdf extends TCPDF {
        ...
        $rows = '<table>';
            ...
            $total = ($inplantcharge + $additional) + ($subTotal - $discount);
           	...
           	$rows .= '
                ...
                <tr>
                    <td></td><td></td><td></td><td></td>
                    <td style="text-align: right;" colspan="2">In Plant Charge</td>
                    <td style="text-align: right;">'.Yii::app()->format->formatNumber($inplantcharge).'</td>
                </tr>
                <tr>
                    <td></td><td></td><td></td><td></td>
                    <td style="text-align: right;" colspan="2">Additional</td>
                    <td style="text-align: right;">'.Yii::app()->format->formatNumber($additional).'</td>
                </tr>
                <tr>
                    <td></td><td></td><td></td><td></td>
            ...
            $this->writeHTMLCell(200,'',4,89,$classRows.$rows, 0, 2);
    ...
    public function Header() {
        ...
        $this->SetFont('helvetica','',9);
            ...
            ';
            $this->writeHTMLCell('','',5,45,$class.$html, 0, 2);
            ...
            ';
            $this->writeHTMLCell('', '', 5, 60, $classCustomer.$customerDetails, 0, 2);
            ...
            $this->writeHTMLCell('','',5,72.5,$classTestingTitle.$testingTitle, 0, 2);   

            $this->writeHTMLCell('','',5,77,$classTestingHeader.$testingHeader, 0, 2);   
    }
        ...
        $reportDue = '
            <table>
                <tr>
                    ...
                    <td width="425">'.$request->reportDue.'</td>
                </tr>
            </table>
        ';

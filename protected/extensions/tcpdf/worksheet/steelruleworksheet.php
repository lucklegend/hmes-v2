...
class steelruleworksheet extends TCPDF {
    ...
    public function Header() {
        ...
        $headDetails = array(
            'title'=>'CALIBRATION WORKSHEET OF STEEL RULE',
            'code'=>'HME-CM-303-F01',
        );
    ...
    public function printRows() {
        ...
        <table border="0">
            ...
            <tr><td height="5"></td></tr>
            <tr>
                <td width="540" style="text-align:justify;">The instrument was calibrated in accordance with HME-CM-303, “Calibration Method of Steel Rule” based on Japan Industrial Standard, JIS 7516:2005.
                </td>
            </tr>

...
class Lab extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('labName, labCode, labCount, nextRequestCode, status', 'required'),
			array('labCount, status', 'numerical', 'integerOnly'=>true),
			array('labName, nextRequestCode', 'length', 'max'=>50),

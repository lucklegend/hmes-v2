...
class Referral extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('code, referredBy, referredTo, type', 'required'),
			array('referredBy, referredTo, type', 'numerical', 'integerOnly'=>true),
			array('code', 'length', 'max'=>24),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, code, referredBy, referredTo, type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('referredTo',$this->referredTo);

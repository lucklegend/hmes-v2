...
class ReceiptController extends Controller
{
	...
	public function actionPrintPDF($id){
		...
		$pdf = Yii::createComponent('application.extensions.tcpdf.printReceiptPdf',
				 					'P', 'mm', array(101,220), true, 'UTF-8');

		$pdf = new printReceiptPdf('P', 'mm', array(101,220), true, 'UTF-8', false);
        ...
        $pdf->SetTitle($receipt->receiptId);               
        ...
        $pdf->Output($receipt->receiptId.'.pdf', 'I');
        //Yii::app()->end();
        exit();
	}
	/*function actionPrintExcel($id){

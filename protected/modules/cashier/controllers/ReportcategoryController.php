...
class ReportcategoryController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Reportcategory');
	 ...
	 * @param Reportcategory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='reportcategory-form')
		{

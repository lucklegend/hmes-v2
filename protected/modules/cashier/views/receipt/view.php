...
<?php echo CHtml::link('<span class="icon-white icon-print"></span> Print', $this->createUrl('receipt/printPDF',array('id'=>$model->id)), array('class'=>'btn btn-info', 'target'=>'_blank', 'onClick'=>$model->cancelled?'return false':'', 'disabled'=>$model->cancelled));?>

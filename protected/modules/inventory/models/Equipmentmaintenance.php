...
class Equipmentmaintenance extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('maintenancedata', 'file','types'=>'pdf', 'allowEmpty'=>true, 'on'=>'create,update'), // this will allow empty field when page is update (remember here i create scenario update)

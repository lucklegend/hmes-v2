	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Customer']))
		{
			...
			if ($_POST['Customer']['municipalitycity_id']!=""){
				$model->region_id=$model->municipality->regionId;
				$model->province_id=$model->municipality->provinceId;
				$model->district=$model->municipality->district;
			}else{
			...
			$compAddress = "";
			if($_POST['Customer']['barangay_id']!=""){
				$barangayName=Barangay::model()->findByPk($_POST['Customer']['barangay_id'])->name;
				$compAddress = $compAddress.', '.$barangayName;	
			}

			if ($_POST['Customer']['municipalitycity_id']!=""){
				$municipalityCity = MunicipalityCity::model()->findByPk($_POST['Customer']['municipalitycity_id'])->name;
				$provinceName = Province::model()->findByPk($_POST['Customer']['province_id'])->name;
				$compAddress = $municipalityCity.', '.$provinceName;			
			}

			if($_POST['Customer']['address'] != "") {
				$compAddress = $_POST['Customer']['address'].", ".$compAddress;
			}
			
			$model->completeAddress=$compAddress;

...
class PackageController extends Controller
{
	...
	function actionGetTestCategorytype(){
	//please enter current controller name because yii send multi dim array 
		if(isset($_POST['Package']['labId']))
			$category = $_POST['Package']['labId'];
		
		$data = Testcategory::model()->findAll('labId=:labId ORDER BY categoryName', 
					  array(':labId'=>$category));

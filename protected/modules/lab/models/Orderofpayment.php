...
class Orderofpayment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, transactionNum, details, collectiontype_id, date, customer_id, customerName, address, amount, purpose, natureOfCollection', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'tsrNumber' => array(self::STAT, 'Paymentitem', 'orderofpayment_id', 'select'=> 'details', 'condition'=>'cancelled=0'),
			'tsrNumbers'=> array(self::HAS_MANY, 'Paymentitem', 'orderofpayment_id','select'=> 'details','condition'=>'cancelled=0'),			
		);
	}
	...
	public function search()
	{
		...
		$criteria->order = 'createdReceipt ASC';

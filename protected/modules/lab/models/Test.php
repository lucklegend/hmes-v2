...
class Test extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('duration, categoryId, sampleType, labId, count', 'numerical', 'integerOnly'=>true),
			array('fee', 'numerical'),
			array('testName, worksheet', 'length', 'max'=>500),
			array('method', 'length', 'max'=>150),
			array('references', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, testName, method, references, fee, duration, categoryId, sampleType, labId, count', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('worksheet',$this->worksheet);
	...
	public static function listData3($labId)
	{
		//return CHtml::listData(Sampletype::model()->findAll(), 'id', 'sampleType');

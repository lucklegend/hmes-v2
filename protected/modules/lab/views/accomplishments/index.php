				...
				array(
			   		'onchange'=>'js:{
								...
								var rstl = '.Yii::app()->Controller->getRstlId().'
			   					$("h3.title").text("RSTL III "+year+" Summary of Accomplishment");
...
<h3 class="title" style="text-align: center; margin-top: -20px; margin-bottom: -20px;"><?php echo 'RSTL III '.$year.' Summary of Accomplishment';?> </h3>

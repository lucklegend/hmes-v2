		...
		<tr>
			...
			<td>
				...
				if($request->labId){
					...
					$labId = $model->test->labId;
				} 					
				echo $form->dropDownList($model,'testName',
				CHtml::listData(Test::model()->findAllByAttributes(array('labId'=>$labId),array('order'=>'testName')), 'id', 'testName'),
				array('ajax'=>array( 
					 	'type'=>'POST',
						'dataType'=>'JSON',

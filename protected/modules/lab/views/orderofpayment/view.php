...
<?php echo CHtml::link('<span class="icon-white icon-print"></span> Print', $this->createUrl('orderofpayment/printPDF',array('id'=>$model->id)), array('class'=>'btn btn-info','target'=>'_blank'));?>
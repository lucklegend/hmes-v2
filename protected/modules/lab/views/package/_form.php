...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'rate', array('value'=>$model->rate ? $model->rate : '0.00', 'readonly'=>false)); ?>
		<?php echo $form->error($model,'rate'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'labId'); ?>
		<?php echo $form->dropDownList($model,'labId', Initializecode::listLabName(), array(
			'ajax'=>array(
				'type'=>'POST',
				'url'=>$this->createUrl('package/getTestCategorytype'),
				'update'=>'#Package_testcategory_id',
			),
			'style'=>'width: 220px;',
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'testcategory_id',
						$model->isNewRecord ? array() : Testcategory::listData2($model->testcategory_id), 
						array('ajax'=>array( 
										'type'=>'POST',
								 		'url'=>$this->createUrl('package/getSampletype'),
								 		'update'=>'#Package_sampletype_id',
								    ),
						'empty'=>'Select Test Category'
								    ));?>

...
<span class="<?php echo $request->reportStatus['class']; ?>" style="float:right; min-width:80px; min-height:30px; line-height:30px;text-align:center;display:inline-block;font-weight:bold;"><?php echo $request->reportStatus['label']; ?></span>
 ...
 $this->widget('zii.widgets.grid.CGridView', array(
 	...
 	'rowHtmlOptionsExpression' => 'array("title"=>"Click on Request Reference Number to view details", "class"=>$data->releaseStatus["class"])',
	'dataProvider'=>$model,
 	'columns'=>array(
 		//'id',
 		array(

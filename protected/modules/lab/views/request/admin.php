...
<div class="span6">
	<div class="row buttons">
		<?php echo CHtml::Link('Create Request',Yii::app()->Controller->createUrl("request/create"), array('class'=>'btn btn-info pull-right')); ?>
	</div>
</div>
<!--
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			...
			'htmlOptions'=>array('title'=>'Click to view details', 'style'=>'width: 120px')
		),
		array(
				'name'=>'requestDate',
		...
		array( 
				...
				'value'=>'Chtml::link($data->customer->customerName,Yii::app()->Controller->createUrl("request/view",array("id"=>$data->id)))',
				'htmlOptions' => array('title'=>'Click to view details', 'style' => 'width: 300px; text-align: left; ')
		),
		array( 
				'name'=>'conforme', 
				// 'value'=>'Request::getORsAdminView($data->receipts)',
				'value'=>'Chtml::link($data->conforme,Yii::app()->Controller->createUrl("request/view",array("id"=>$data->id)))',
				'type'=>'raw',
		...
		array(
				...
				'type'=>'raw',
    			'htmlOptions' => array('style' => 'text-align: right; padding-right: 10px; width: 75px;'),
			),
		array(
				'name'=>'reportDue',
    			'htmlOptions' => array('style' => 'text-align: right; padding-right: 10px;width: 75px;'),

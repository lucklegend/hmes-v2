...
<div class="form">
    ...
    <div class="row">
        <?php 
            echo $form->labelEx($model, 'inplant_charge'); 
            echo $form->textField($model, 'inplant_charge', array('size' => 60, 'maxlength' => 150, 'value' => $model->getInplantCharge())); 
        ?>
    </div>

	...
	<div class="span3">
		<div class="sidebar-nav">
		  ...
		  <?php $this->widget('zii.widgets.CMenu', array(
			...
			'encodeLabel'=>false,
			'items'=>array(
				array('label'=>'<i class="icon icon-home"></i> Dashboard', 'url'=>array('/pstc/default/index')	),
				...
				array('label'=>'<i class="icon icon-user"></i> Requests', 'url'=>array('/pstc/test/admin')	),
				array('label'=>'<i class="icon icon-user"></i> Test / Calibration', 'url'=>array('/pstc/test/admin')	),

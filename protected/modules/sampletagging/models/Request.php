...
class Request extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('requestRefNum, requestId, requestDate, requestTime, rstl_id, labId, sublabId, customerId, paymentType, modeofreleaseId, discount, purposeId, orId, total, reportDue, conforme, receivedBy, cancelled, create_time', 'required'),
			array('rstl_id, labId, sublabId, customerId, paymentType, modeofreleaseId, discount, purposeId, orId, cancelled', 'numerical', 'integerOnly'=>true),
			array('total', 'numerical'),
			array('requestRefNum, requestId, conforme, receivedBy', 'length', 'max'=>50),
			array('requestTime', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, requestRefNum, requestId, requestDate, requestTime, rstl_id, labId, sublabId, customerId, paymentType, modeofreleaseId, discount, purposeId, orId, total, reportDue, conforme, receivedBy, cancelled, create_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
				'samps' => array(self::HAS_MANY, 'Sample', 'request_id', 'condition' => 'samps.cancelled=0'),
		);
	}
	/**
	...
	public function search()
	{
		...
		$criteria->compare('sublabId',$this->sublabId);
		$criteria->compare('customerId',$this->customerId);
		$criteria->compare('paymentType',$this->paymentType);
		$criteria->compare('modeofreleaseId',$this->modeofreleaseId);
		$criteria->compare('discount',$this->discount);
		$criteria->compare('purposeId',$this->purposeId);

...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?php if ($request->labId == 2){ ?> 
	<div class="row">
	    <?php echo $form->labelEx($model,'samplingDate'); ?>
		<?php //echo $requestId.'--'.$request->labId.' '.$form->labelEx($model,'samplingDate');  ?>
		<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
						'name'=>'Sample[samplingDate]',
						'value'=>$model->samplingDate ? date('m/d/Y',strtotime($model->samplingDate)) : date('m/d/Y'),

<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <a class="brand" href="<?php echo Yii::app()->request->baseUrl;?>/"><?php echo CHtml::image(Yii::app()->request->baseUrl."/images/logo.png");?> <?php echo CHtml::encode(Yii::app()->name);?></a>
          <?php 
          		$menu = array();
          		// $menu = array(
          		// 			array('label'=>'Quotation', 
          		// 					'url'=>array('/portal/quotation/view')
          		// 				),
          		// 	);
				if(Yii::app()->user->isSuperuser){
					$menu = array(
						array('label'=>'Cashier', 'url'=>array('/cashier/orderofpayment/admin')),
						array('label'=>'Lab', 'url'=>array('/lab/request/admin')),
